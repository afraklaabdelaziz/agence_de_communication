...
( function( $ ){
	...
	OPNControlTrigger = {
	    ...
	    {
	    	$( 'body' ).trigger( 'big-store-control-trigger.' + hook, args );
	    },
	    ...
	    {
	    	$( 'body' ).on( 'big-store-control-trigger.' + hook, callback );
	    },
	    ...
	    {
		    $( 'body' ).off( 'big-store-control-trigger.' + hook, callback );
	    },
	};
...
( function( $ ){
	...
	OPNCustomizer = {
		...
		_initToggles: function()
		{
			...
			OPNControlTrigger.triggerHook( 'big-store-toggle-control', api );
