...
function zbscrmJS_customFields_buildLineFiles(area,namestr){
  ...
  var html = '<tr class="zbscrm-cf"><td class="">';
    html += '<input type="text" class="form-control" name="wpzbscrm_cf[' + area + '][name][]" value="' + namestr + '" placeholder="' + zeroBSCRMJS_settingsLang('fileboxname','File Box Name') + '" /><br />';
...
function zbscrmJS_customFields_buildLine(area,typestr,namestr,placeholder,slug){
  ...
  */
	...
	html += '<input type="text" class="form-control" name="wpzbscrm_cf[' + area + '][name][]" value="' + namestr + '" placeholder="' + zeroBSCRMJS_settingsLang('fieldname','Field Name') + '" />';
	...
	html += '<label class="zbscrm-cf-fieldtype-label">' + zeroBSCRMJS_settingsLang('fieldtype','Field Type:') + '</label>';
	...
	html += '<div class="zbscrm-cf-settings-wrap">';
		...
		html += '<input type="text" class="form-control zbs-generic-hide zbs-generic" name="wpzbscrm_cf[' + area + '][placeholder][]" value="' + placeholder + '" placeholder="' + zeroBSCRMJS_settingsLang('fieldplacehold','Field Placeholder Text') + '" />';
	...
	// autonumber (only shows if )
		...
		html += '<div class="zbs-cf-type-autonumber-wrap zbs-generic-hide zbs-cf-type-autonumber">';
			...
			html += '<div class="zbs-cf-type-autonumber-input-wrap"><div class="ui labeled input"><div class="ui label">' + zeroBSCRMJS_settingsLang('prefix','Prefix') + '</div>';
				html += '<input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="wpzbscrm_cf[' + area + '][anprefix][]" value="' + autonumberPrefix + '" placeholder="' + zeroBSCRMJS_settingsLang('prefix','Prefix') + ' ' + zeroBSCRMJS_settingsLang('prefixe','(e.g. ABC-)') + '" />';
			html += '</div></div>';
			html += '<div class="zbs-cf-type-autonumber-input-wrap"><div class="ui labeled input"><div class="ui label">' + zeroBSCRMJS_settingsLang('nextnumber','Next Number') + '</div>';
				html += '<input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber intOnly zbs-dc" name="wpzbscrm_cf[' + area + '][annextnumber][]" value="' + autonumberNumb + '" placeholder="' + zeroBSCRMJS_settingsLang('nextnumber','Next Number') + ' ' + zeroBSCRMJS_settingsLang('nextnumbere','(e.g. 1)') + '" />';
			html += '</div></div>';
			html += '<div class="zbs-cf-type-autonumber-input-wrap"><div class="ui labeled input"><div class="ui label">' + zeroBSCRMJS_settingsLang('suffix','Suffix') + '</div>';
				html += '<input type="text" class="form-control zbs-generic-hide zbs-cf-type-autonumber" name="wpzbscrm_cf[' + area + '][ansuffix][]" value="' + autonumberSuffix + '" placeholder="' + zeroBSCRMJS_settingsLang('suffix','Suffix') + ' ' + zeroBSCRMJS_settingsLang('suffixe',' (e.g. -FINI)') + '" />';
			html += '</div></div>';
		html += '</div>';
...
function zbscrmJS_customFields_buildSelect(area,typestr){
  ...
  var selectHTML = '<select class="form-control zbscrm-customtype" name="wpzbscrm_cf[' + area + '][type][]" id="wpzbscrm_cf[' + area + '][type][]">';
...
function zbscrmJS_customFields_buildNonSelect(area,typestr){
    ...
    html += '<input type="hidden" name="wpzbscrm_cf[' + area + '][type][]"  class="zbscrm-customtype" id="wpzbscrm_cf[' + area + '][type][]" value="' + typestr + '">';
...
function zbscrmJS_customFields_bindRowControls(){
	...
	// remove line
	jQuery('.zbscrm-remove').off('click').on( 'click', function(){
	...
	// change of type
	jQuery('.zbscrm-customtype').off('change').on( 'change', function(){
