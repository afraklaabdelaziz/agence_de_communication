...
function zeroBSCRMJS_initEditView(){
    ...
    //console.log('settings init');
        ...
        jQuery('#zbs-edit-save').off('click').on( 'click', function(){
...
function zeroBSCRMJS_editContactInit(){
        ...
        // profile pic edit
        jQuery('#zbs-contact-edit-avatar').on( 'mouseenter', function(){
        ...
        jQuery('#zbs-edit-contact-avatar').on( 'click', function(e) {
            e.preventDefault();
            var image = wp.media({ 
...
function jpcrm_bind_linkify() {
        ...
        if (v.length > 5) {
            ...
            if (typeof possMatch == "object" && typeof possMatch !== "null"){
                ...
                if (possMatch != null && possMatch[0] != "undefined"){
                    ...
                    // linkify
                    jQuery(ele).parent().addClass('ui action input fluid').append('<button class="ui icon button zbs-linkify" type="button" data-url="' + encodeURI(possMatch[0]) + '" title="Go To ' + encodeURI(possMatch[0]) + '"><i class="linkify icon"></i></button>');
 ...
 function zeroBSCRMJS_bindLinkify(){
    ...
    jQuery('.zbs-linkify').off('click').on( 'click', function(){
...
function zeroBSCRMJS_events_bindContactLinkIf(){
    ...
    jQuery('.zbs-task-for .zbs-view-contact').off('click').on( 'click', function(){
...
function zeroBSCRMJS_events_bindCompanyLinkIf(){
    ...
    jQuery('.zbs-task-for-company .zbs-view-company').off('click').on( 'click', function(){
