 ...
 */
 jQuery(function(){
    ...
    if (typeof window.zbsViewSettings != "undefined") zeroBSCRMJS_initSingleView();


    // check type :)
    if (typeof window.zbsViewSettings != "undefined" && typeof window.zbsViewSettings.objdbname != "undefined" && window.zbsViewSettings.objdbname == 'contact'){
    ...
    // check type :)
    if (typeof window.zbsViewSettings != "undefined" && typeof window.zbsViewSettings.objdbname != "undefined" && window.zbsViewSettings.objdbname == 'company'){
...
function zeroBSCRMJS_bindViewFiles(){
        ...
        jQuery('.zbsDelFile').on( 'click', function(){
            ...
            // get type
            var delType = 'customer'; if (jQuery(this).attr('data-type') == 'company') delType = 'company';
            ...
            if (!window.zbsCurrentlyDeleting){
                ...
                var objID = -1; if (typeof window.zbsViewSettings != "undefined" && typeof window.zbsViewSettings.objid != "undefined") var objID = window.zbsViewSettings.objid;
                ...
                if (typeof delUrl != "undefined" && delUrl != '' && objID > 0){
                      ...
                      jQuery.ajax({
                              ...
                              success: function(response) {
                                ...
                                if (newNumber == 1) jQuery('#zbs-no-files-msg').show();
                                ...
                                if (typeof response.errors != "undefined" && response.errors.length > 0){
                                    ...
                                    jQuery.each(response.errors,function(ind,ele){
                                        ...
                                        jQuery('#zbsFilesTable').after('<div class="ui warning message" style="margin-top:10px;">' + ele + '</div>');
                              ...
                              error: function(response){
                                ...
                                jQuery('#zbsFilesTable').append('<div class="ui warning message" style="margin-top:10px;"><strong>' + window.zbsViewLang.error + ':</strong> ' + window.zbsViewLang.unabletodelete + '</div>');
...
============================================================================================================ */
  ...
  function zeroBSCRMJS_bindActivityStream(){
        ...
        // log long desc toggles
        jQuery('.zbs-show-longdesc').off('click').on( 'click', function(){

            jQuery(this).closest('.zbs-single-log').addClass('zbs-long-desc-show');

        });
        jQuery('.zbs-hide-longdesc').off('click').on( 'click', function(){
