...
(function() {
	...
	var formStyles =  [{text:'Naked',value:'naked'},{text:'Content Grab',value:'cgrab'},{text:'Simple',value:'simple'}];
					...
					editor.windowManager.open(
						{
							...
							onsubmit: function(e) {
								...
								if (e.data.zbscrmformid != -1) {
									tinymce.activeEditor.execCommand("mceInsertContent", false, '[jetpackcrm_form id="' + e.data.zbscrmformid + '" style="' + e.data.zbscrmformstyle + '"]');
								}
								else {
