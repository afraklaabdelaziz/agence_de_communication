...
function zeroBSCRMJS_initListView(){
            ...
            jQuery('#zbs-screenoptions-records-per-page').off('change').on( 'change', function(){
                ...
                zeroBSCRMJS_saveScreenOptions(function(){
                    ...
                    // update list view
                        ...
                        zbsListViewParams.count = parseInt(document.getElementById('zbs-screenoptions-records-per-page').value);
            ...
            jQuery('#zbs-columnmanager-bottomsave').off('click').on( 'click', function(){
            ...
            jQuery('#zbs-open-column-manager').off('click').on( 'click', function(){
        ...
        function zeroBSCRMJS_bindSideBar(){
            ...
            // search click
            jQuery('#zbs-listview-runsearch').off('click').on( 'click', function(){
        ...
        function zeroBSCRMJS_listViewBulkActions() {
            ...
            html = '<div class="jpcrm-bulk-actions">\
                        <select class="jpcrm-bulk-actions-dropdown" disabled>\
                            <option>' + zeroBSCRMJS_listViewLang('rows_selected_0') + '</option>\
                        </select>\
                        <button disabled class="jpcrm-bulk-actions-button ui tiny button primary" style="margin-left:0.4em">Go</button>\
                    </div>';
            return html;
        }
        ...
        function zeroBSCRMJS_listViewPagination() {
            ...
            // toward the end: show first, triple dot, and last five
                ...
                pages_to_add = [1,'...',total_pages-4,total_pages-3,total_pages-2,total_pages-1,total_pages];
            }
            ...
            if (cur_page > 1) {
                list_view_pagination_HTML += '<a class="icon item" href="' + cur_base_URL+'&paged='+ (cur_page-1) + '">';
            } else {
            ...
            for (var i=0; i<pages_to_add.length; i++) {
                if (pages_to_add[i] == '...') {
                    ...
                    list_view_pagination_HTML += '<a class="item' + (pages_to_add[i]==cur_page?' active':'') + '" href="' + cur_base_URL+'&paged='+pages_to_add[i] + '">' + pages_to_add[i] + '</a>';
                }
            }
            ...
            if (window.zbsListViewParams.columns.length > 0){
                var listViewHeaderHTML = '';
                    ...
                    if (typeof window.zbsBulkActions != "undefined" && window.zbsBulkActions.length > 0) {
                        listViewHeaderHTML += '<th class="zbs-listview-bulk-hd"><div class="ui fitted checkbox"><input type="checkbox" id="jpcrm-bulk-select" /><label for="jpcrm-bulk-select"></label></div></th>';
                    }
                        ...
                        if (typeof window[fieldFuncName] == 'function'){
                            ...
                            if (typeof window[fieldFuncName] == 'function'){
                                ...
                                if (typeof data[lvhEle.fieldstr + '_cfdate'] != "undefined" && data[lvhEle.fieldstr + '_cfdate'] != null && data[lvhEle.fieldstr + '_cfdate'] != 'null'){
                                    ...
                                    lineHTML += '<td>' + jpcrm_abbreviate_str(data[lvhEle.fieldstr + '_cfdate'],80,'...','return') + '</td>';
                                    ...
                                    if (typeof data[lvhEle.fieldstr] != "undefined" && data[lvhEle.fieldstr] != null && data[lvhEle.fieldstr] != 'null')
                                        lineHTML += '<td>' + jpcrm_abbreviate_str(data[lvhEle.fieldstr],80,'...','return') + '</td>';
                                    else
        ...
        function zeroBSCRMJS_listViewFooter(){
            ...
            listViewFooterHTML +=  '<div id="zbs-listview-footer-count">' + zbscrmjs_prettifyLongInts(window.zbsListViewCount) + ' ' + objStrName + '</div>';
        ...
        function zeroBSCRMJS_listView_bulkActionsUpdate(){
            ...
            zbsBulkActions.forEach(function(action_name) {
                ...
                if (typeof window[bulkActionTitleFuncName] == 'function'){
                    ...
                    bulkActionTitleFuncName = 'zeroBSCRMJS_listView_' + window.zbsListViewSettings.objdbname + '_bulkActionTitle_' + action_name;
                    if (typeof window[bulkActionTitleFuncName] == 'function') {
                        optnamehtml = window[bulkActionTitleFuncName]();
                    }
            ...
            bulk_actions_els = document.querySelectorAll('.jpcrm-bulk-actions-dropdown, .jpcrm-bulk-actions-button');
            ...
            setTimeout(function(){
                ...
                jQuery('.jpcrm-bulk-actions-button').off('click').on( 'click', function(){
                    ...
                    var cur_action = this.parentElement.querySelector('.jpcrm-bulk-actions-dropdown option:checked').value;
                    ...
                    if (typeof window[bulkActionFuncName] == 'function'){
                        ...
                        var optFuncName = 'zeroBSCRMJS_listView_' + window.zbsListViewSettings.objdbname + '_bulkActionFire_' + cur_action;
                        window[optFuncName]();
    ...
    function zeroBSCRMJS_listView_generic_bulkActionFire_addtag(){
        ...
        swal({
          ...
          onOpen: function(){
                ...
                jQuery('.zbs-select-tag input:checkbox').off('click').on( 'click', function(){
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_customer_bulkActionFire_changestatus(){
            ...
            if (typeof window.zbsStatusesForBulkActions != "undefined" && window.zbsStatusesForBulkActions.length > 0){
            ...
            swal({
              ...
              html: '<div>' + zeroBSCRMJS_listViewLang('statusareyousurethese') + '</div>' + status_selector_html,
              //text: "Are you sure you want to delete these?",
              type: 'warning',
              showCancelButton: true,
              confirmButtonColor: '#3085d6',
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_generic_lastupdated(dataLine){
            ...
            // DAL3
            if (date == '' && typeof dataLine['lastupdated_date'] != "undefined") date = dataLine['lastupdated_date'];

            // DAL2
            if (date == '' && typeof dataLine['lastupdated'] != "undefined") date = dataLine['lastupdated'];
        ...
        function zeroBSCRMJS_listView_generic_hasquote(dataLine){
            ...
            return '<td class="center aligned">' + ((hasQuote) ? '<i class="large green checkmark icon"></i>' : '') + '</td>';
        }
        // Draw <td> for has inv
        function zeroBSCRMJS_listView_generic_hasinvoice(dataLine){
            ...
            return '<td class="center aligned">' + ((hasInvoice) ? '<i class="large green checkmark icon"></i>' : '') + '</td>';
        }
        // Draw <td> for has inv
        function zeroBSCRMJS_listView_generic_hastransaction(dataLine){
            ...
            // check for objects
            if (typeof dataLine['transactions'] != 'undefined' && dataLine['transactions'] != 0 && dataLine['transactions'] != '0'){
            ...
            // check for total
            if (typeof dataLine['transactions_total_value'] != 'undefined' && dataLine['transactions_total_value'] > 0){

                hasTransaction = true;

            }

            return '<td class="center aligned">' + ((hasTransaction) ? '<i class="large green checkmark icon"></i>' : '') + '</td>';
        }
        ...
        function zeroBSCRMJS_listView_generic_quotecount(dataLine){
            ...
            return '<td>' + ((typeof dataLine['quotes'] != "undefined") ? dataLine['quotes'].length : '') + '</td>';
        ...
        function zeroBSCRMJS_listView_generic_invoicecount(dataLine){
            ...
            return '<td>' + ((typeof dataLine['invoices'] != "undefined") ? dataLine['invoices'].length : '') + '</td>';
        ...
        function zeroBSCRMJS_listView_generic_transactioncount(dataLine){
            ...
            return '<td>' + ((typeof dataLine['transactions'] != "undefined") ? dataLine['transactions'].length : '') + '</td>';
        ...
        function zeroBSCRMJS_listView_generic_quotetotal(dataLine){
            ...
            return '<td>' + ((typeof dataLine['quotestotal'] != "undefined") ? dataLine['quotestotal'] : '') + '</td>';
        ...
        function zeroBSCRMJS_listView_generic_invoicetotal(dataLine){
            ...
            return '<td>' + ((typeof dataLine['invoicestotal'] != "undefined") ? dataLine['invoicestotal'] : '') + '</td>';
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_customer_editlink(dataLine){
            ...
            return '<td class="center aligned"><a href="' + zeroBSCRMJS_listView_viewURL(dataLine['id']) + '" class="ui basic button"><i class="icon pencil"></i>' + window.zbs_lang.zbs_view + '</a></td>';

        }
        // Draw <td> for  edit link
        function zeroBSCRMJS_listView_customer_editdirectlink(dataLine){
   
            return '<td class="center aligned"><a href="' + zeroBSCRMJS_listView_editURL(dataLine['id']) + '" class="ui basic button"><i class="icon pencil"></i>' + window.zbs_lang.zbs_edit + '</a></td>';
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_segment_name(dataLine){
            ...
            var td = '<td><a href="' + zeroBSCRMJS_listView_editURL(dataLine['id']) + '">' + name_str + '</a></td>';
        ...
        function zeroBSCRMJS_listView_segment_audiencecount(dataLine){
            ...
            if (typeof dataLine['compilecount'] != "undefined"){
                ...
                compStr = '<span class="ui label teal" title="' + window.zbsListViewLangLabels.lastCompiled + ' ' + dataLine['lastcompileddate'] + '">' + compile_count + '</span>';
                ...
                if (typeof window.zbsSegmentViewStemURL != "undefined" && typeof dataLine['slug'] != "undefined"){
                    compStr = '<div class="ui left labeled button" title="' + window.zbsListViewLangLabels.lastCompiled + ' ' + dataLine['lastcompileddate'] + '"><a class="ui basic right pointing label">' + compile_count + '</a><a href="' + window.zbsSegmentViewStemURL + dataLine['slug'] + '" class="ui button"><i class="list icon"></i> ' + window.zbsListViewLangLabels.view + '</a></div>';
                }
            }
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_transaction_external_source(dataLine){
            var v = '';
            if (typeof dataLine['external_source_uid'] != "undefined" && dataLine['external_source_uid'] !== false) {
...
==================================================================================== */
        ...
        function zeroBSCRMJS_listView_event_remind(dataLine){
            ...
            if ( dataLine.reminders.length > 0 ) remind = true;
        ...
        function zeroBSCRMJS_listView_event_showcal(dataLine){
            ...
            if ( dataLine.show_on_cal == 1 ) show = true;
        ...
        function zeroBSCRMJS_listView_event_showportal(dataLine){
            ...
            if ( dataLine.show_on_portal == 1 ) show = true;
        ...
        function zeroBSCRMJS_listView_event_contact(dataLine){
            ...
            var contact = '';
            if ( typeof dataLine['contact']['fullname'] != "undefined" ) contact = dataLine['contact']['fullname'];
        ...
        function zeroBSCRMJS_listView_event_company(dataLine){
            ...
            var company = '';
            if ( typeof dataLine['company']['fullname'] != "undefined" ) company = dataLine['company']['fullname'];
        ...
        function zeroBSCRMJS_listView_event_action(dataLine){
            ...
            var td = '<td><strong><a href="' + zeroBSCRMJS_listView_viewURL(dataLine['id']) + '" class="ui basic button"><i class="icon pencil"></i> ' + zeroBSCRMJS_listViewLang('edit') + '</a></strong></td>';
        ...
        function zeroBSCRMJS_listView_event_status(dataLine){
            ...
            var status = '<span class="ui grey label">' + zeroBSCRMJS_listViewLang('incomplete') + '</span>';

            if (dataLine.complete == 1) status = '<span class="ui green label">' + zeroBSCRMJS_listViewLang('complete') + '</span>';
            ...
            swal({
              ...
              //allowOutsideClick: false,
                ...
                if (result.value){
                    ...
                    // fire delete + will automatically refresh list view
                    zeroBSCRMJS_enactBulkAction('markcomplete',zeroBSCRMJS_listView_bulkActionsGetChecked(),extraParams,function(r){
            ...
            swal({
              ...
              //allowOutsideClick: false,
                ...
                if (result.value){
                    ...
                    // fire delete + will automatically refresh list view
                    zeroBSCRMJS_enactBulkAction('markincomplete',zeroBSCRMJS_listView_bulkActionsGetChecked(),extraParams,function(r){
...
==================================================================================== */
    ...
    function zeroBSCRMJS_bindInlineEditing(){
        ...
        jQuery('#zbs-list-wrap td.zbs-inline-edit').off('click').on( 'click', function(){
