...
<head>
	...
	<title><?php _e( 'Welcome to Jetpack CRM', 'zero-bs-crm' );?></title>
...
<body class="zbscrm-setup wp-core-ui">
			<h1 id="zbscrm-logo"><a href="https://jetpackcrm.com" target="_blank"><img src="<?php echo jpcrm_get_logo(false); ?>" alt="Jetpack CRM"></a></h1>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="wizopt">
                    ...
                    <label><?php _e(jpcrm_label_company().' Name / CRM Name:',"zero-bs-crm");?></label>
                ...
                <div class="wizopt">
                    ...
                    <div class="zbs-extrainfo">
                        ...
                        <em><strong><?php _e("This is super useful if you intend to use the CRM on its own domain (e.g. crm.yourdomain.com)","zero-bs-crm");?>.</strong></em><br />
                ...
                <div class="wizopt" style="display:none">
                    ...
                    <label><?php _e('B2B Mode', 'zero-bs-crm'); ?></label>
                    <p><?php _e("Jetpack CRM an run in 'Business to business' (B2B) Mode, which allows you to manage 'Contacts' under '".jpcrm_label_company(true)."', instead of just 'Contacts'. For most small businesses and freelancers, this isn't necessary","zero-bs-crm");?>.</p>
                ...
                <div class="wizopt">
                    ...
                    <label for="zbs_ess"><?php _e('Usage Tracking',"zero-bs-crm"); ?></label>

                    <div style="width:100%;">
                        <div style="width:25%;float:left;">
                            <div class='yesplsess'><p><?php _e('Usage Tracking',"zero-bs-crm"); ?> <input type="checkbox" id="zbs_ess" value="zbs_ess" checked='checked'/></p></div>
                        </div>
                        <div style="width:75%;float:right;">
                            <div class="zbs-extrainfo">
                                <?php _e( 'Share CRM usage data with us. No contact or sensitive CRM data is shared. This helps us build a better CRM by understanding how our users are using it.', 'zero-bs-crm');?> <a href="<?php echo $zbs->urls['usagetrackinginfo']; ?>" style="color: #000000;" target="_blank" ><?php _e( 'Click here to learn more.', 'zero-bs-crm' );?></a>
                            </div>
                        </div>
                        <div class='clear'></div>
                    </div>
                    ...
                    <div class="zbs-show-starterbundle zbs-sync-wrap">
                        ...
                        <div class='zbs-eb-wizard'>
                            <div class='zbs-eb-callout'>
                                ...
                                <a href="<?php echo $zbs->urls['pricing']; ?>" target="_blank" class="btn btn-jetpack">Connect your CRM to other services</a>
                            </div>
                            <div id="zbs-starterbundle-img" class="zbs-sync-img">
                                <a href="<?php echo $zbs->urls['pricing']; ?>" target="_blank"><img src="<?php echo ZEROBSCRM_URL; ?>i/welcome-to-zbs/entrepreneur-bundle.png" alt="Entrepreneur Bundle" /></a>
                            </div>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="wizopt">
                    ...
                    <label><?php _e( 'Enable WooSync', 'zero-bs-crm' ); ?></label>
                    <p><?php _e( 'Automatically import all your customers, transactions, and invoices from WooCommerce, a full-featured eCommerce solution for WordPress.', 'zero-bs-crm' ); ?></p>
                    <p class="zbs-extra"><?php _e( 'Note that you will also need a site that has the free WooCommerce plugin installed.', 'zero-bs-crm' ); ?></p>
                ...
                <div class="wizopt">
                    ...
                    <div class="zbs-extrainfo">
                        <strong><?php _e( 'Hint', 'zero-bs-crm' ); ?>:</strong> <?php _e( 'You can always enable or disable these and other CRM features from the WordPress admin menu under CRM Settings → Core Modules.', 'zero-bs-crm' ); ?>
                    </div>
    ...
    <div class="row setup-content" id="step-4" style="display:none">
        <div class="col-xs-12">
            <div class="col-md-12 laststage">
                ...
                <p style="font-size:16px;color:#e06d17"><strong><?php _e("Join the Jetpack CRM community today","zero-bs-crm");?>:</strong><br />(<?php _e("Bonuses, Critical update notifications","zero-bs-crm");?>.)</p>
            ...
            <div class="col-md-12 finishingupblock" style="display:none">
                <h3><?php _e("Configuring your Jetpack CRM","zero-bs-crm");?></h3>
            ...
            <div class="col-md-12 finishblock" style="display:none">
                ...
                <div style='text-align:center'>
                <p><?php _e("That’s it, you’re good to go. Get cracking with using your new CRM!","zero-bs-crm");?></p>
                ...
                <div class="text-center">
                    <div style="margin:20px">
                        <img src="<?php echo ZEROBSCRM_URL; ?>i/welcome-to-zbs/fireworks.png">
                    </div>
                    <a class="btn btn-success center btn-lg zbs-finito" href="<?php echo admin_url($loc); ?>"><?php _e("Finish and go to your CRM","zero-bs-crm");?>!</a>
                </div>
            </div>
        </div>
    </div>
