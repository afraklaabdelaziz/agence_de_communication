...
<div style="margin:1em">
    <div class="ui card jpcrm-user-profile centered">
      ...
      <div class="content">
        ...
        <div class="meta">
          <span class="date"><?php echo sprintf( __("User since %s", 'zero-bs-crm'), date( 'F j, Y, g:i a', strtotime( $user_data->user_registered ) ) ); ?></span>
        </div>
          ...
          <?php 
            ...
            if ( is_array( $user_data->roles) && count( $user_data->roles ) > 0){
                ...
                foreach ( $user_data->roles as $role ){
                    ...
                    ?><span class="ui tag label"><?php echo $role; ?></span><?php
                }

            } else {

                _e( 'No roles detected', 'zero-bs-crm' );
            }
      ...
      <div class="extra content" style="text-align: center">
          <a href="<?php echo get_edit_profile_url( $user_wp_id ); ?>" class="ui small blue icon button centered"><i class="user icon"></i>&nbsp;&nbsp;<?php _e( 'Edit Your Profile', 'zero-bs-crm' ); ?></a>        
      </div> 
