   ...
   <div class='panel'>
      ...
      if (
        ...
        <div class='ui message blue' style="text-align:center;margin-bottom:50px;">
            ...
            <?php ##WLREMOVE ?><br/><br/>
            <a class="button ui blue" href="<?php echo $zbs->urls['kbcrmdashboard']; ?>"><?php _e("Read Guide","zero-bs-crm");?></a>
            <?php ##/WLREMOVE ?>
        </div>
      <?php } else { ?>
      ...
      <div class='funnel-legend'>
          <?php
            ...
            foreach($zbsFunnelArrR as $Funnel){
                echo '<div class="zbs-legend" style="background:'.$colors[$j - $i -1].'"></div><div class="zbs-label">  ' . $Funnel . '</div>';
                $i++;
            }
          ?>
      </div>
    ...
    <div class='panel'>
      ...
      <?php  $currencyChar = zeroBSCRM_getCurrencyChr(); ?>
        ...
        <?php if (!zeroBSCRM_isExtensionInstalled('salesdash')) {?>
          <span class='upsell'><a href="<?php echo $zbs->urls['salesdash']; ?>" target="_blank"><?php _e("Want More?","zero-bs-crm");?></a></span>
        <?php } else { ?>
      ...
      if(!is_array($trans) || array_sum($trans) == 0){ ?>
        <div class='ui message blue' style="text-align:center;margin-bottom:80px;margin-top:50px;">
            ...
            <?php ##WLREMOVE ?><br/><br/>
            <a class="button ui blue" href="<?php echo $zbs->urls['kbrevoverview']; ?>"><?php _e("Read Guide","zero-bs-crm");?></a>
            <?php ##/WLREMOVE ?>
        </div>
      <?php }else{ ?>
    ...
    <div class="panel">
        ...
        <?php if (count($latestLogs) > 0) foreach($latestLogs as $log){
          ...
          if (isset($log['author'])) $logauthor = ' &mdash; ' . $log['author']; 
            ...
            ?>
            <div class='feed-item'>
              <div class='date'><img class='ui avatar img img-rounded' alt='<?php _e("Contact Image","zero-bs-crm") ?>' src='<?php echo $avatar ?>'/></div>
              <div class='content text'>
                <span class='header'><?php echo $logmetatype ?><span class='when'> (<?php echo $diff . __(" ago","zero-bs-crm") ?>)</span><span class='who'><?php echo $logauthor ?></span></span>
                <div class='description'><?php echo $logmetashot ?><br/></div>
              </div>
            </div>
          <?php } else { ?>
            <div class='feed-item'>
              <div class='content text'>
                <span class='header'><?php _e('Contact Log Feed',"zero-bs-crm")?><span class='when'> (<?php _e("Just now","zero-bs-crm")?>)</span></span>
                <div class='description'>
                  <?php _e('This is where recent Contact actions will show up',"zero-bs-crm") ?>
                  <br/>
                </div>
              </div>
            </div>
                  ...
                  <?php
                    foreach($latest_cust as $cust){
                      ...
                      <tr>
                        ...
                        <td><img class='img-rounded' alt='<?php _e('Contact Image','zero-bs-crm','') ?>' src='<?php echo esc_attr($avatar) ?>'/></td>
                        ...
                        <td><div class='mar'><a href='<?php echo zbsLink('view',$cust['id'],'zerobs_customer') ?>'><?php _e('View',"zero-bs-crm"); ?></a></div></td>
