  ...
  <div class="content">
    <div class="jpcrm-modal-body ui grid">
      <div class="jpcrm-modal-cta-group eight wide column middle aligned" id="jpcrm-modal-cta-group">
        ...
        <div class="jpcrm-modal-paragraph"><?php _e( "Your CRM starts with your contacts. Start collecting your contact information all in one place and use it to nurture your relationships.", 'zero-bs-crm' ); ?></div>
        <div class="jpcrm-modal-actions">
          ...
          <a href="<?php echo admin_url( 'admin.php?page=' . $zbs->slugs['csvlite'] );?>" class="ui white button jpcrm-modal-action-import"><?php _e( "Import contacts (CSV)", 'zero-bs-crm' ); ?></a>
        </div>
      </div>
        ...
        <div class="ui grid">
          ...
          <div class="seven wide column">
            ...
            <div class="jpcrm-modal-learn-footer">
              ...
              <div class="jpcrm-modal-learn-footer-paragraph"><?php _e( "Mike is one of the team behind Jetpack CRM. Through these videos he will help you use Jetpack CRM to its full potential.", 'zero-bs-crm' ); ?></div>
