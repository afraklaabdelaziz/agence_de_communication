...
function jpcrm_render_system_v3migration_log(){
    ...
    if ($zbs->isDAL3()){
        ...
        ?><p style="text-align:center;margin:2em">
            ...
            <a href="<?php echo esc_url(zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']).'&tab=status&cacheCheck=1'); ?>" class="ui button teal"><?php _e('View Migration Cache','zero-bs-crm'); ?></a><?php } ?>
            <a href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']).'&tab=status'; ?>" class="ui button blue"><?php _e('Back to System Status',"zero-bs-crm"); ?></a>
        </p><?php
      ...
      if (isset($_GET['clearCache'])){
        ...
        // show cache
          ...
          ?></tbody></table><?php
            ...
            ?><p style="text-align:center;margin:2em">
                <?php if (zeroBSCRM_isZBSAdminOrAdmin()){ ?>
                <a href="<?php echo wp_nonce_url('?page='.$zbs->slugs['systemstatus'].'&tab=status&cacheCheck=1&clearCache=1','clearmigrationcache'); ?>" class="ui button orange"><?php _e('Clear Migration Cache','zero-bs-crm'); ?></a><?php } ?>
                <a href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']) . '&tab=status'; ?>" class="ui button blue"><?php _e('Back to System Status',"zero-bs-crm"); ?></a>
            </p><?php
...
function zeroBSCRM_render_systemstatus_page(){
  ...
  ?>
        ...
        <p><?php _e('This page allows easy access for the various system status variables related to your WordPress install and Jetpack CRM.',"zero-bs-crm"); ?></p>
        ...
        <div id="sbA" style="margin-right:1em">
              ...
              <div class="ui segment">
                ...
                <a href="<?php echo wp_nonce_url('?page='.$zbs->slugs['systemstatus'].'&tab=status&resetuserroles=1','resetuserroleszerobscrm'); ?>" class="ui button blue"><?php _e('Re-build User Roles',"zero-bs-crm"); ?></a>
                <?php if ($zbs->isDAL3()){ ?><a href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['systemstatus']).'&tab=status&v3migrationlog=1'; ?>" class="ui button blue"><?php _e('v3 Migration Logs',"zero-bs-crm"); ?></a><?php } ?>
              </div>
