              ...
              /*
                  ...
                  ?><div class="three wide column" style="text-align:center">
                    ...
                    <div class="thirteen wide column zbs-view-card"><?php
                      ...
                      <h3>
                        <?php echo zeroBS_companyName('',$company,false,false); ?>
                    ...
                    <table class="ui fixed single line celled table">
                      <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php if (count($company['quotes']) > 0)
                                      echo zeroBSCRM_formatCurrency($companyQuotesValue).' ('.count($company['quotes']).')';
                                    else
                                      _e('None',"zero-bs-crm"); ?>
                            </td>
                          </tr>
                        ...
                        <tr class="zbs-view-vital-invoices">
                          ...
                          <td>
                            <?php if (count($company['invoices']) > 0)
                                    echo zeroBSCRM_formatCurrency($companyInvoicesValue).' ('.count($company['invoices']).')';
                                  else
                                    _e('None',"zero-bs-crm"); ?>
                          </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if (count($company['transactions']) > 0)
                                    echo zeroBSCRM_formatCurrency($companyTransactionsValue).' ('.count($company['transactions']).')';
                                  else
                                    _e('None',"zero-bs-crm"); ?>
                          </td>
                        </tr>
                        ...
                        <tr class="zbs-view-vital-source">
                          <td class="zbs-view-vital-label"><?php ( $company_external_source_count > 1 ?  _e( "Sources", "zero-bs-crm" ) : _e( "Source", "zero-bs-crm" ) ); ?></td>
                          <td>
                            <?php                            
                    ...
                    <div class="ui bottom attached <?php if ($activeTab == 'invoices') echo 'active '; ?>tab segment" data-tab="invoices">
                        <table class="ui celled table unstackable">
                              ...
                              <tbody>
                                ...
                                $new_invoice_url = zbsLink('create',-1,ZBS_TYPE_INVOICE).'&prefillco='.$company['id'];
                    ...
                    <div class="ui bottom attached <?php if ($activeTab == 'transactions') echo 'active '; ?>tab segment" data-tab="transactions">
                        ...
                        <table class="ui celled table unstackable">
                              ...
                              <tbody>
                                ...
                                $new_transaction_url = zbsLink('create',-1,ZBS_TYPE_TRANSACTION).'&prefillco='.$company['id'];
                      ...
                      <div class="ui bottom attached <?php if ($activeTab == 'tasks') echo 'active '; ?>tab segment" data-tab="tasks">
                          <table class="ui celled table unstackable">
                                ...
                                <tbody>
                                  ...
                                  $new_task_url = zbsLink('create',-1,ZBS_TYPE_EVENT).'&prefillco='.$company['id'];
