...
function jpcrm_send_single_email_from_box( $send_to_email = '', $thread_id = -1, $delivery_method = -1, $exit_json = true, $do_nl2br = false){
  ...
  if ( zeroBSCRM_validateEmail( $send_to_email ) ){
      ...
      $content = ''; if (isset($_POST['zbs_send_email_content'])) $content = zeroBSCRM_textProcess( $_POST['zbs_send_email_content'] );
      if ( $do_nl2br ) {
      ...
      $newLogID = zeroBS_addUpdateContactLog($contact_id,-1,-1,array(
        'type' => 'Email',
