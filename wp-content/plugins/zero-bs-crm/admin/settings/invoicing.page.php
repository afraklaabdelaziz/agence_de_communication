...
<p id="sbDesc"><?php _e('Tailor CRM invoicing to work for your business or organisation.',"zero-bs-crm"); ?></p>
...
<div id="sbA">
    ...
    <form method="post">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th colspan="2" class="wmid"><?php _e( "General Invoice Settings:", 'zero-bs-crm' ); ?></th>
            </tr>
            ...
            <tr>
                <td class="wfieldname">
                        <label><?php _e('Reference type',"zero-bs-crm"); ?>:</label><br /><?php _e('Select the default reference system for your invoices',"zero-bs-crm"); ?>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invtax"><?php _e( 'Enable tax:', 'zero-bs-crm' ); ?></label><br /><?php _e( 'Tick if you plan to charge tax.', 'zero-bs-crm' ); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invdis"><?php _e( 'Enable discounts:', 'zero-bs-crm' ); ?></label><br /><?php _e( 'Tick if you want to add discounts.', 'zero-bs-crm' ); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invpandp"><?php _e( 'Enable shipping:', 'zero-bs-crm' ); ?></label><br /><?php _e( 'Tick if you want to add shipping (postage and packaging).', 'zero-bs-crm' ); ?></td>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th colspan="2" class="wmid"><?php _e( "Invoice Display Settings:", 'zero-bs-crm' ); ?></th>
            </tr>
            ...
            <tr>
                <td class="wfieldname">
                    ...
                    <label for="inv_pdf_template"><?php _e( 'Invoice PDF Template', 'zero-bs-crm' ) ?>:</label><br />
                    <?php _e( "Select a template for invoice PDFs.", 'zero-bs-crm' ) ?>                    
                </td>
                <td><?php 
            ...
            <tr>
                <td class="wfieldname">
                    <div class="ui teal label right floated"><i class="circle info icon link"></i>  <a href="<?php echo $zbs->urls['kbtemplatefiles']; ?>" target="_blank"><?php _e('Read more','zero-bs-crm'); ?></a></div>
                    <label for="inv_portal_template"><?php _e( 'Invoice Portal Template', 'zero-bs-crm' ) ?>:</label><br />
                    <?php _e( "Select a template for invoices on the Portal.", 'zero-bs-crm' ) ?>
                </td>
                <td><?php 
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="winput form-control" id="reflabel" name="reflabel" placeholder="e.g. Ref." value="<?= isset( $settings['reflabel'] ) ? $settings['reflabel'] : __('Reference', 'zero-bs-crm') ?>"/>
                </td>
            </tr>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_invid"><?php _e( 'Hide Invoice ID', 'zero-bs-crm'); ?>:</label><br /><?php _e( 'Tick if you want to hide the invoice ID in the invoice editor. This is a system-generated ID that auto-increments.', 'zero-bs-crm' ); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="jpcrm_invcustomfields"><?php _e( 'Invoice custom fields to display', "zero-bs-crm"); ?>:</label><br /><?php _e( 'Enter the slug for each invoice custom field you wish to display, separated by commas (e.g. <code>approved,newbatch</code>).', 'zero-bs-crm'); ?></td>
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_invcustomfields" name="jpcrm_invcustomfields" placeholder="" value="<?= isset( $settings['invcustomfields'] ) ? $settings['invcustomfields'] : ''; ?>"/>
                    <?php
                        ...
                        if ( is_array( $contact_custom_fields ) && count( $contact_custom_fields ) > 0 ){
                            ...
                            echo '<div class="ui segment jpcrm-custom-field-builder" data-target="jpcrm_invcustomfields">' . __( 'Available custom fields:', 'zero-bs-crm' ) . '<br>';
                            foreach ( $contact_custom_fields as $field_key => $field_label ){
                                echo '<span class="ui label teal" style="margin-top:3px">' . $field_key . '</span>&nbsp;';
                            }
                            echo '</div>';
                        }
            ...
            <tr>
                <td class="wfieldname"><label for="jpcrm_contactcustomfields"><?php _e( 'Contact custom fields to display', 'zero-bs-crm' ); ?>:</label><br /><?php _e( 'Enter slugs for each contact custom field you wish to display, separated by commas (e.g. <code>hobby,specialism</code>).', 'zero-bs-crm' ); ?></td>
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_contactcustomfields" name="jpcrm_contactcustomfields" placeholder="" value="<?= isset( $settings['contactcustomfields'] ) ? $settings['contactcustomfields'] : ''; ?>"/>
                    <?php
                        ...
                        if ( is_array( $contact_custom_fields ) && count( $contact_custom_fields ) > 0 ){
                            ...
                            echo '<div class="ui segment jpcrm-custom-field-builder" data-target="jpcrm_contactcustomfields">' . __( 'Available custom fields:', 'zero-bs-crm' ) . '<br>';
                            foreach ( $contact_custom_fields as $field_key => $field_label ){
                                echo '<span class="ui label teal" style="margin-top:3px">' . $field_key . '</span>&nbsp;';
                            }
                            echo '</div>';
            ...
            <tr>
                <td class="wfieldname"><label for="jpcrm_companycustomfields"><?php _e( 'Company custom fields to display', 'zero-bs-crm' ); ?>:</label><br /><?php _e( 'Enter slugs for each company custom field you wish to display, separated by commas (e.g. <code>division,area</code>).', 'zero-bs-crm' ); ?></td>
                <td style="width:540px">
                    <input type="text" class="winput form-control" id="jpcrm_companycustomfields" name="jpcrm_companycustomfields" placeholder="" value="<?= isset( $settings['companycustomfields'] ) ? $settings['companycustomfields'] : ''; ?>"/>
                    <?php
                        ...
                        if ( is_array( $company_custom_fields ) && count( $company_custom_fields ) > 0 ){
                            ...
                            echo '<div class="ui segment jpcrm-custom-field-builder" data-target="jpcrm_companycustomfields">' . __( 'Available custom fields:', 'zero-bs-crm' ) . '<br>';
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th colspan="2" class="wmid"><?php _e('Statement Settings:',"zero-bs-crm"); ?></th>
            </tr>
            ...
            <tr>
                <td class="wfieldname">
                    <div class="ui teal label right floated"><i class="circle info icon link"></i>  <a href="<?php echo $zbs->urls['kbtemplatefiles']; ?>" target="_blank"><?php _e('Read more','zero-bs-crm'); ?></a></div>
                    <label for="statement_pdf_template"><?php _e( 'Statement PDF Template', 'zero-bs-crm' ) ?>:</label><br />
                    <?php _e( "Select a template for statement PDFs.", 'zero-bs-crm' ) ?>                    
                </td>
                <td><?php 
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th colspan="2" class="wmid"><?php _e('Invoice Portal Settings:',"zero-bs-crm"); ?></th>
            </tr>
            ...
            <tr>
                <td class="wfieldname"><label for="paythanks"><?php _e( 'Thank You', 'zero-bs-crm' ); ?>:</label><br /><?php _e( 'If text is specified, it will be shown after a user pays for their invoice via portal.', 'zero-bs-crm' ); ?></td>
            ...
            <tr>
                <td colspan="2">
                    <p style="text-align:center"><?php _e( 'Looking for easy-access link settings? You can turn configure those via the Client Portal settings page.', 'zero-bs-crm' ); ?></p>
