...
<div id="sbA" class="zbs-settings-custom-fields">
    ...
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=fieldoptions">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th class="wmid"><?php _e('General Field Options',"zero-bs-crm"); ?>:</th>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th class="wmid"><?php _e('Contact Field Options',"zero-bs-crm"); ?>:</th>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th class="wmid"><?php _e('Funnels',"zero-bs-crm"); ?>:</th>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wmid"><button type="submit" class="ui button primary"><?php _e('Save Field Options',"zero-bs-crm"); ?></button></td>
            </tr>
