...
<p id="sbDesc"><?php _e('Here you can modify the settings for the built-in CRM forms.', 'zero-bs-crm'); ?>

<?php ##WLREMOVE ?>
<?php echo sprintf( __( 'Want to use third-party forms like Contact Form 7 or Gravity Forms? Check out our <a href="%s" target="_blank">Form Extensions</a>!', 'zero-bs-crm' ), $zbs->urls['products'] );?></a>
<?php ##/WLREMOVE ?>
</p>
...
<div id="sbA">
    ...
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=forms">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <th class="wmid"><?php _e('Forms Settings',"zero-bs-crm"); ?>:</th>
            </tr>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_showformspoweredby"><?php _e('Show "Powered by"',"zero-bs-crm"); ?></label><br /><?php _e('Show us some love by displaying the "Powered by" in your form footers',"zero-bs-crm"); ?>.</td>
            ...
            <tr>
                <td class="wfieldname">
                    <label for="wpzbscrm_usegcaptcha"><?php _e('Enable reCaptcha',"zero-bs-crm"); ?></label>
                    <p><?php _e("This setting enables reCaptcha for the built-in CRM forms. If you'd like to use this to avoid spam, please sign up for a site key and secret <a href='https://www.google.com/recaptcha/admin#list' target='_blank'>here</a>.", 'zero-bs-crm') ?></p>
                    <p><?php _e('Note that only reCaptcha v2 is supported at this time.', 'zero-bs-crm') ?></p>
                </td>
