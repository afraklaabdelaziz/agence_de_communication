...
$tab_page_map = [
    ...
    'companies' => [
        ...
        'title-notice'      => array(
                                'colour' => 'blue',
                                'icon' => 'circle info',
                                'body' => __( 'This area is part of the B2B module', 'zero-bs-crm' ) . ' <a href="' . esc_url( zbsLink( $zbs->slugs['modules'] ) ) . '" target="_blank">' . __( 'Manage Modules', 'zero-bs-crm' ) . '</a>'
                            )
    ],
    'woosync' => [
        'page'              => 'woosync',
        'title'             => __( 'WooCommerce Sync Settings', "zero-bs-crm" ),
