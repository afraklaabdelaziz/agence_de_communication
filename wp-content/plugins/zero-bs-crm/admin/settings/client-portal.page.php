...
<p id="sbDesc"><?php _e('Configure your Client Portal settings here.',"zero-bs-crm"); ?></p>
...
?>
    <form method="post" action="?page=<?php echo $zbs->slugs['settings']; ?>&tab=clients">
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_showportalpoweredby"><?php _e('Show "Powered by Jetpack CRM"',"zero-bs-crm"); ?></label><br /><?php _e('Show us some love by displaying the "Powered by" footer on your portal.',"zero-bs-crm"); ?></td>
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_portalpage"><?php _e('Client Portal page',"zero-bs-crm"); ?></label><br /><?php _e("Select the page with your client portal shortcode.","zero-bs-crm");?>
                    <?php ##WLREMOVE ?>
                    <a href="<?php echo $zbs->urls['kbclientportal']; ?>" target="_blank"><?php _e("Learn More", "zero-bs-crm"); ?></a>
                    <?php ##/WLREMOVE ?>
                </td>
                <td>
                    <?php
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_easyaccesslinks"><?php _e('Allow Easy-Access links',"zero-bs-crm"); ?></label><br /><?php _e('Tick to allow logged-out users to view quotes and invoices via a secure hash URL.',"zero-bs-crm"); ?>
                    <?php ##WLREMOVE ?>
                    <a href="<?php echo $zbs->urls['kbeasyaccess']; ?>" target="_blank"><?php _e("Learn More", "zero-bs-crm"); ?></a>
                    <?php ##/WLREMOVE ?>
                </td>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td colspan="2" class="wmid">
                    <?php
                    _e( 'WordPress users are required for each contact to access to your Client Portal if Easy-Access links are not enabled.', 'zero-bs-crm' );
                    echo '<br>';
                    _e( 'You can generate these manually from any contact record, or automatically by enabling the setting below.', 'zero-bs-crm' ); ?>
                    <hr />
            ...
            <tr>
                <td class="wfieldname"><label for="wpzbscrm_portalusers"><?php _e('Generate WordPress users for new contacts',"zero-bs-crm"); ?></label><br /><?php _e("By default this will automatically email the new contact a welcome email as soon as they're added. If you prefer to not have this email sent, you can disable this email template.","zero-bs-crm"); ?>
                    <?php ##WLREMOVE ?>
                    <a href="<?php echo $zbs->urls['kbdisablewelcome']; ?>" target="_blank"><?php _e("Learn More", "zero-bs-crm"); ?></a>
                    <?php ##/WLREMOVE ?>
                </td>
            ...
            <tr>
                <td class="wfieldname"><label><?php _e('Only generate users for statuses',"zero-bs-crm"); ?></label><br />
                    <br /><?php
            ...
            <tr>
                <td width="94">
                    <label for="wpzbscrm_portal_hidefields"><?php _e('Fields to hide on Portal',"zero-bs-crm"); ?></label><br /><?php _e('These fields will not be shown to the client in the client portal under "Your Details" (and so will not be editable).',"zero-bs-crm"); ?>
                </td>
                <td>
                    <?php
                    ...
                    <small style="margin-top:4px"><?php _e("Default setting","zero-bs-crm");?>:<br /><span style="background:#ceeaea;padding:0 4px">status,email</span></small>
                </td>
            </tr>
        ...
        <table class="table table-bordered table-striped wtab">
            ...
            <tr>
                <td class="wmid"><button type="submit" class="ui button primary"><?php _e('Save Settings',"zero-bs-crm"); ?></button><a target="_blank" href="<?php echo $portalLink;?>" class="ui button green"><?php _e('Preview Portal',"zero-bs-crm");?></a></td>
            </tr>
