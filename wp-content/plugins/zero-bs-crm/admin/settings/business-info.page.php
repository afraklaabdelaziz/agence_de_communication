...
<form method="post">
    ...
    <table class="table table-bordered table-striped wtab">
        ...
        <tr>
            <td class="wfieldname"><label for="businessyourname"><?php _e('Owner Name',"zero-bs-crm"); ?>:</label><br /><?php _e('The name of the business owner which will be shown on your invoices.',"zero-bs-crm"); ?></td>
    ...
    <table class="table table-bordered table-striped wtab">
        ...
        <tr>
            <td class="wfieldname"><label for="wpzbs_linkedin"><?php _e('LinkedIn ID',"zero-bs-crm"); ?>:</label></td>
        ...
        <tr>
            <th colspan="2" style="text-align:center;padding:1em">
                <strong><?php _e("... and don't forget to follow Jetpack CRM on Twitter!","zero-bs-crm"); ?></strong><br /><br />
                <a href="<?php echo $zbs->urls['twitter']; ?>" class="ui green button" target="_blank"><i class="twitter icon"></i> @jetpackcrm</a><br /><br />
            </th>
        </tr>
        <?php ##/WLREMOVE ?>
