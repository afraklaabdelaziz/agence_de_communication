...
class zbsDAL_invoices extends zbsDAL_ObjectLayer {
    ...
    private function tidy_invoice($obj=false,$withCustomFields=false){
            ...
            */
            ...
            $res['date_date'] = (isset($obj->zbsi_date) && $obj->zbsi_date > 0) ? zeroBSCRM_date_i18n(-1,$obj->zbsi_date,false,true) : false;
            $res['due_date'] = (int)$obj->zbsi_due_date;
            $res['due_date_date'] = (isset($obj->zbsi_due_date) && $obj->zbsi_due_date > 0) ? zeroBSCRM_date_i18n(-1,$obj->zbsi_due_date,false,true) : false;
