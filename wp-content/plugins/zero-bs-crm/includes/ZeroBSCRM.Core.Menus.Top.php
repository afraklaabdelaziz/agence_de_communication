...
function zeroBSCRM_admin_top_menu($branding = 'zero-bs-crm', $page = 'dash'){
	    ...
	    <div class="ui mobile tablet only" id="zbs-mobile-nav">
			<div id="zbs-main-logo-mobile">
			    <div class="zbs-face-1-mobile">
			        <img id="zbs-main-logo-mobby" alt="Jetpack CRM mobile logo" src="<?php echo jpcrm_get_logo(true,'white'); ?>" style="cursor:pointer;">
			    </div>
			</div>
			<?php
			...
			<!-- basic menu tabs for mobile -->
				...
				<?php if($b2bMode == 1){  ?>
					<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['managecompanies']) ?>"><i class="icon building outline"></i> <?php echo jpcrm_label_company(true); ?></a>
				<?php } ?>
		...
		<div class="item <?php echo $admin_menu_state;?> mobile hidden" id="zbs-main-logo-wrap">
			<div class="zbs-cube" id="zbs-main-logo-cube-wrap">
			    <div class="zbs-face1">
			        <img id="zbs-main-logo" alt="Jetpack CRM logo" src="<?php echo jpcrm_get_logo(); ?>" style="cursor:pointer;">
			    </div>
			    <div class="zbs-face2">
				...
				<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
				  ...
				  <div class="ui divider"></div>
					...
					<div class="ui simple dropdown item " id="zbs-companies-topmenu">
						<?php echo jpcrm_label_company(true); ?><i class="dropdown icon zbs-subsub-ico"></i>
						<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
							<?php
				  ...
				  <div class="ui divider"></div>
				    ...
				    <?php if(!zeroBSCRM_isExtensionInstalled('csvpro') && zeroBSCRM_isExtensionInstalled('csvimporterlite')){ ?>
								<a class="item" href="<?php echo admin_url('admin.php?page='.$zbs->slugs['csvlite']);?>"><?php echo zeroBSCRM_isExtensionInstalled('csvpro'); ?><i class="icon cloud upload"></i> <?php _e("Import","zero-bs-crm"); ?></a>
				    <?php } else {
		...
		<div class="ui simple dropdown item select" id="zbs-extensions-topmenu" style="z-index:5">
			...
			<i class="dropdown icon"></i>
			<div class="menu ui inverted zbs-admin-bg-menu zbs-dropdown">
				<a class="item" href="<?php echo zeroBSCRM_getAdminURL($zbs->slugs['modules']) ?>"><i class="icon th" aria-hidden="true"></i> Core Modules</a>
				<?php
				##WLREMOVE
				?>
