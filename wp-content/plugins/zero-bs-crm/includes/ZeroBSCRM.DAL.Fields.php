  ...
  (Defaults which can be overriden by custom fields + field sorts)
    ...
    */
    ...
    global $zbsCustomerFields;
        ...
        $zbsCustomerFields = array(
            ...
            'fname' => array('text',__('First Name',"zero-bs-crm"),'e.g. John', 'essential' => true),
            'lname' => array('text',__('Last Name',"zero-bs-crm"),'e.g. Doe', 'essential' => true),
            #'src' => array('select','Source','',$srcArray),
            'addr1' => array('text',__('Address Line 1',"zero-bs-crm"),'','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'addr2' => array('text',__('Address Line 2',"zero-bs-crm"),'','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'city' => array('text',__('City',"zero-bs-crm"),'e.g. London','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'county' => array('text',__('County',"zero-bs-crm"),'e.g. Greater London','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'postcode' => array('text',__('Post Code',"zero-bs-crm"),'e.g. E1 9XJ','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),


            'country' => array('selectcountry',__('Country',"zero-bs-crm"),'e.g. UK','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),


            'secaddr_country' => array('selectcountry',__('Country',"zero-bs-crm"),'e.g. UK','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),


            'secaddr_addr1' => array('text',__('Address Line 1',"zero-bs-crm"),'','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_addr2' => array('text',__('Address Line 2',"zero-bs-crm"),'','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_city' => array('text',__('City',"zero-bs-crm"),'e.g. London','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_county' => array('text',__('County',"zero-bs-crm"),'e.g. Greater London','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_postcode' => array('text',__('Post Code',"zero-bs-crm"),'e.g. E1 9XJ','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            ...
            'email' => array('email',__('Email',"zero-bs-crm"),'e.g. john@yahoo.com', 'essential' => true),
    ...
    global $zbsCompanyFields;
        ...
        $zbsCompanyFields = array(
            ...
            'coname' => array('text',__('Name',"zero-bs-crm"),'e.g. Dell', 'essential' => true),

            'addr1' => array('text',__('Address Line 1',"zero-bs-crm"),'','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'addr2' => array('text',__('Address Line 2',"zero-bs-crm"),'','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'city' => array('text',__('City',"zero-bs-crm"),'e.g. London','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'county' => array('text',__('County',"zero-bs-crm"),'e.g. Greater London','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'postcode' => array('text',__('Postcode',"zero-bs-crm"),'e.g. E1 9XJ','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            'country' => array('selectcountry',__('Country',"zero-bs-crm"),'e.g. UK','area'=>__('Main Address',"zero-bs-crm"),'migrate'=>'addresses'),
            ...
            'secaddr_city' => array('text',__('City',"zero-bs-crm"),'e.g. London','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_county' => array('text',__('County',"zero-bs-crm"),'e.g. Greater London','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_postcode' => array('text',__('Postcode',"zero-bs-crm"),'e.g. E1 9XJ','area'=>__('Second Address',"zero-bs-crm"),'opt'=>'secondaddress','migrate'=>'addresses'),
            'secaddr_country' => array('selectcountry',__('Country',"zero-bs-crm"),'e.g. UK','area'=>__('Second Address',"zero-bs-crm"),'migrate'=>'addresses'),
    ...
    global $zbsCustomerQuoteFields;
        ...
        $zbsCustomerQuoteFields = array(
            ...
            'name' => array('text',__('Quote Title',"zero-bs-crm"),'e.g. New Website', 'essential' => true),
            'val'=> array('price',__('Quote Value',"zero-bs-crm"),'e.g. 500.00', 'essential' => true),
            'date' => array('date',__('Quote Date',"zero-bs-crm"),'', 'essential' => true),
            'notes' => array('textarea',__('Notes',"zero-bs-crm"),'')
    ...
    $zbsFormFields = array(
        ...
        'header' => array('text', __('Header',"zero-bs-crm"), 'Want to find out more','nocolumn'=>true),
        'subheader' => array('text', __('Sub Header',"zero-bs-crm"), 'Drop us a line. We follow up on all contacts','nocolumn'=>true),
        'fname' => array('text', __('First Name Placeholder',"zero-bs-crm"), 'First Name','nocolumn'=>true),
        'lname' => array('text', __('Last Name Placeholder',"zero-bs-crm") , 'Last Name','nocolumn'=>true),
        'email' => array('text', __('Email Placeholder',"zero-bs-crm"), 'Email','nocolumn'=>true),
        'notes' => array('text',__('Message Placeholder',"zero-bs-crm"), 'Your Message','nocolumn'=>true),
        'submit' => array('text', __('Submit Button',"zero-bs-crm"), 'Submit','nocolumn'=>true),
        'spam' => array('textarea', __('Spam Message',"zero-bs-crm"), 'We will not send you spam. Our team will be in touch within 24 to 48 hours Mon-Fri (but often much quicker)','nocolumn'=>true),
        'success' => array('text', __('Success Message',"zero-bs-crm"), 'Thanks. We will be in touch.','nocolumn'=>true)
    ...
    */
        ...
        $zbsTransactionFields = array(
                ...
                /* REQUIRED: */
                'orderid'   => array('text',__('Transaction ID',"zero-bs-crm"),'e.g. 123456', 'essential' => true),
                'customer'  => array('text',__('Customer ID',"zero-bs-crm"),'e.g. 1234', 'essential' => true),
                'status'    => array(
                            'select', 'Status','',array(
                                'Succeeded','Completed','Failed','Refunded','Processing','Pending','Hold','Cancelled'
                            ), 'essential' => true),
                'total'     => array('price',__('Total Value',"zero-bs-crm"),'e.g. 100.99', 'essential' => true),

                /* RECOMMENDED: */
                'customer_name'=> array('text',__('Customer Name',"zero-bs-crm"),'e.g. John Doe','nocolumn'=>true),
