			...
			$useTrans = zeroBSCRM_getSetting('feat_transactions');
	   		...
	   		// later: rights checks here (E.g. can edit?)   		
				...
				$actions_array['edit'] = array(
						...
						'url' =>  zbsLink('edit',$cID,'zerobs_customer'), // zeroBSCRM_getEditLink($cID),
				...
				// Quotes
				if ($useQuotes == "1") $actions_array['addquote'] = array(

						'url' => zbsLink('create',-1,ZBS_TYPE_QUOTE).'&zbsprefillcust='.$cID,//admin_url('post-new.php?post_type=zerobs_quote&zbsprefillcust='.$cID),
				...
				if ($useInvoices == "1") {
					...
					$actions_array['addinvoice'] = array(
						...
						'url' => zbsLink('create',-1,ZBS_TYPE_INVOICE).'&zbsprefillcust='.$cID,//admin_url('post-new.php?post_type=zerobs_invoice&zbsprefillcust='.$cID),
				...
				$actions_array['addtransaction'] = array(
						...
						'url' => zbsLink('create',-1,ZBS_TYPE_TRANSACTION).'&zbsprefillcust='.$cID,//admin_url('post-new.php?post_type=zerobs_transaction&zbsprefillcust='.$cID),
				...
				$actions_array['addlog'] = array(
						...
						'url' => zbsLink('edit',$cID,'zerobs_customer').'&addlog=1#zerobs-customer-logs',
	   			...
	   			if(zeroBSCRM_isExtensionInstalled('cal'))
	   				...
	   				$actions_array['addtask'] = array(
	   						...
	   						'url' => zbsLink('create',-1,ZBS_TYPE_EVENT).'&zbsprefillcust='.$cID,//admin_url('post-new.php?post_type=zerobs_event&zbsprefill='.$cID),
				...
				$actions_array['sendemail'] = array(
						...
						'url' => zbsLink('email',$cID,'zerobs_customer'),//zeroBSCRM_getAdminURL($zbs->slugs['emails']).'&zbsprefill='.$cID,
				...
				if ($zbs->isDAL3()){
					...
					$actions_array['delete'] = array(
							...
							'url' =>  zbsLink('delete',$cID,'zerobs_customer'), // zeroBSCRM_getEditLink($cID),
   		...
   		if (!empty($coID)){
	   		...
	   		// later: rights checks here (E.g. can edit?)   		
				...
				$actions_array['edit'] = array(
						...
						'url' =>  zbsLink('edit',$coID,'zerobs_company'), // zeroBSCRM_getEditLink($cID),
