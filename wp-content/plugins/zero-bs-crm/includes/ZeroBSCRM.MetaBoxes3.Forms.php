                ...
                <?php foreach ($zbsFormFields as $fieldK => $fieldV){
                   ...
                   switch ($fieldV[0]){
                        ...
                        case 'text':
                            ...
                            <td>
                                <input type="text" name="<?php echo $this->fieldPrefix.$fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control widetext" placeholder="<?php if (isset($fieldV[2])) _e($fieldV[2],"zero-bs-crm"); ?>" value="<?php if (isset($form[$fieldK])) echo $form[$fieldK]; ?>" />
                            </td></tr><?php
                        ...
                        case 'textarea':
                            ...
                            ?><tr class="wh-large"><th><label for="<?php echo $fieldK; ?>"><?php _e($fieldV[1],"zero-bs-crm"); ?>:</label></th>
                            <td>
                                <textarea name="<?php echo $this->fieldPrefix.$fieldK; ?>" id="<?php echo $fieldK; ?>" class="form-control" placeholder="<?php if (isset($fieldV[2])) _e($fieldV[2],"zero-bs-crm"); ?>"><?php if (isset($form[$fieldK])) echo zeroBSCRM_textExpose($form[$fieldK]); ?></textarea>
                            </td></tr><?php
    ...
    class zeroBS__Metabox_FormActions extends zeroBS__Metabox{ 
        ...
        public function html( $form, $metabox ) {
            ...
            ?><div class="zbs-generic-save-wrap">
                    ...
                    <div class="ui medium dividing header"><i class="save icon"></i> <?php _e('Form','zero-bs-crm'); ?> <?php _e('Actions','zero-bs-crm'); ?></div>
