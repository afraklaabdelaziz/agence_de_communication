    ...
    public function deleteEvent($args=array()){
        ...
        if (!empty($id) && $id > 0) {
            ...
            if ($saveOrphans === false){
                ...
                // delete any objlinks
                if ($zbs->isDAL2()) $this->addUpdateObjectLinks($id,'unset',ZBS_TYPE_EVENT);

                // delete any reminders
                if ($zbs->isDAL2()) $this->DAL()->eventreminders->deleteEventRemindersForEvent(array('eventID'=>$id));
