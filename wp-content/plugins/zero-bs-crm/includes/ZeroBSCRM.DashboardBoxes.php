                ...
                <div class='panel' style="padding:20px;height:400px;padding-bottom:50px;">
                    <div class="panel-heading" style="text-align:center">
                        <div class="contact-display-chooser">
                            ...
                            <h4 class="panel-title text-muted font-light">CRM contacts</h4>

                            
                            <div class="ui buttons day-or-month">
                                <div class="ui button" data-range="daily">Day</div>
                                <div class="ui button" data-range="weekly">Week</div>
                                <div class="ui button selected" data-range="monthly">Month</div>
                                <div class="ui button" data-range="yearly">Year</div>
                            </div>
                        </div>
                    </div>
