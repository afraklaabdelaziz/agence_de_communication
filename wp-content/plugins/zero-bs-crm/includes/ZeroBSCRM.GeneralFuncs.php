...
function zeroBSCRM_portal_linkObj($objID=-1,$typeInt=ZBS_TYPE_INVOICE){
	...
	switch ($typeInt){
		...
		case ZBS_TYPE_INVOICE:
            ...
            $invoices_endpoint   = jpcrm_get_portal_endpoint( ZBS_TYPE_INVOICE );
		...
		case ZBS_TYPE_QUOTE:
			...
			// get quotes stem	
            $quotes_endpoint   = jpcrm_get_portal_endpoint( ZBS_TYPE_QUOTE );
 ...
 */
function jpcrm_secure_directory_from_external_access( $directory_path = '', $include_htaccess = true ) {
