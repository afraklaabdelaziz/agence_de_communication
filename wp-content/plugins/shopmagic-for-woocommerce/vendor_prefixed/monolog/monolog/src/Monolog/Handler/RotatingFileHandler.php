 ...
 */
class RotatingFileHandler extends \ShopMagicVendor\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \ShopMagicVendor\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \ShopMagicVendor\Monolog\Utils::canonicalizePath($filename);
