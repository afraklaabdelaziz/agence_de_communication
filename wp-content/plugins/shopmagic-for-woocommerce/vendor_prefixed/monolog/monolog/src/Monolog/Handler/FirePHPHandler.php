...
use ShopMagicVendor\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \ShopMagicVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \ShopMagicVendor\Monolog\Formatter\WildfireFormatter();
    }
    /**
