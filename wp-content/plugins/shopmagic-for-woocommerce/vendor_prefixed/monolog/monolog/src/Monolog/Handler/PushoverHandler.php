 ...
 */
class PushoverHandler extends \ShopMagicVendor\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \ShopMagicVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \ShopMagicVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \ShopMagicVendor\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \ShopMagicVendor\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \ShopMagicVendor\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
