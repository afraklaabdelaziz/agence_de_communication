 ...
 */
class SlackbotHandler extends \ShopMagicVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \ShopMagicVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
