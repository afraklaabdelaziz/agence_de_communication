 ...
 */
class SocketHandler extends \ShopMagicVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \ShopMagicVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
