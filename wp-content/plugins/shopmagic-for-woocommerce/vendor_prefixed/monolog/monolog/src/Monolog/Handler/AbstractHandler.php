 ...
 */
abstract class AbstractHandler implements \ShopMagicVendor\Monolog\Handler\HandlerInterface, \ShopMagicVendor\Monolog\ResettableInterface
{
    protected $level = \ShopMagicVendor\Monolog\Logger::DEBUG;
    ...
    {
        $this->level = \ShopMagicVendor\Monolog\Logger::toMonologLevel($level);
        return $this;
    }
    /**
    ...
    {
        return new \ShopMagicVendor\Monolog\Formatter\LineFormatter();
    }
}
