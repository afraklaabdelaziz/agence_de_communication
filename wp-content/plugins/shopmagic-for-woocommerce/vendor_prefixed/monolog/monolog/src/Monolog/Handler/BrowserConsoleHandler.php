 ...
 */
class BrowserConsoleHandler extends \ShopMagicVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \ShopMagicVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
