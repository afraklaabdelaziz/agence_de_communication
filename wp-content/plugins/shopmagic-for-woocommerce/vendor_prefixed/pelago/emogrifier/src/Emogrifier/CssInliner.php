...
namespace ShopMagicVendor\Pelago\Emogrifier;

use ShopMagicVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor;
use ShopMagicVendor\Symfony\Component\CssSelector\CssSelectorConverter;
 ...
 */
class CssInliner extends \ShopMagicVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
{
    /**
     * @var int
     */
    ...
    private function getCssSelectorConverter()
    {
        if ($this->cssSelectorConverter === null) {
            $this->cssSelectorConverter = new \ShopMagicVendor\Symfony\Component\CssSelector\CssSelectorConverter();
        }
    ...
    {
        $this->caches = [static::CACHE_KEY_CSS => [], static::CACHE_KEY_SELECTOR => [], static::CACHE_KEY_CSS_DECLARATIONS_BLOCK => [], static::CACHE_KEY_COMBINED_STYLES => []];
    }
    /**
