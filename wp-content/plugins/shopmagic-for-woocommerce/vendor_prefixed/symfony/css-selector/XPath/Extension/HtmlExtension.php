 ...
 * @internal
 */
class HtmlExtension extends \ShopMagicVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
{
    public function __construct(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\Translator $translator)
    {
        $translator->getExtension('node')->setFlag(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\Extension\NodeExtension::ELEMENT_NAME_IN_LOWER_CASE, \true)->setFlag(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\Extension\NodeExtension::ATTRIBUTE_NAME_IN_LOWER_CASE, \true);
    }
    /**
     * {@inheritdoc}
     */
     ...
     * @return XPathExpr
     */
    public function translateChecked(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
     ...
     * @return XPathExpr
     */
    public function translateLink(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
     ...
     * @return XPathExpr
     */
    public function translateDisabled(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
     ...
     * @return XPathExpr
     */
    public function translateEnabled(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
    ...
    public function translateLang(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \ShopMagicVendor\Symfony\Component\CssSelector\Node\FunctionNode $function)
    {
        ...
        return $xpath->addCondition(\sprintf('ancestor-or-self::*[@lang][1][starts-with(concat(' . "translate(@%s, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ', 'abcdefghijklmnopqrstuvwxyz'), '-')" . ', %s)]', 'lang', \ShopMagicVendor\Symfony\Component\CssSelector\XPath\Translator::getXpathLiteral(\strtolower($arguments[0]->getValue()) . '-')));
    }
    /**
     * @return XPathExpr
     */
    public function translateSelected(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
     ...
     * @return XPathExpr
     */
    public function translateInvalid(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
     ...
     * @return XPathExpr
     */
    public function translateHover(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
        return $xpath->addCondition('0');
    }
    /**
     * @return XPathExpr
     */
    public function translateVisited(\ShopMagicVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath)
    {
        return $xpath->addCondition('0');
    }
    /**
