 ...
 * @internal
 */
class WhitespaceHandler implements \ShopMagicVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
{
    /**
     * {@inheritdoc}
     */
    public function handle(\ShopMagicVendor\Symfony\Component\CssSelector\Parser\Reader $reader, \ShopMagicVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream)
    {
        ...
        $stream->push(new \ShopMagicVendor\Symfony\Component\CssSelector\Parser\Token(\ShopMagicVendor\Symfony\Component\CssSelector\Parser\Token::TYPE_WHITESPACE, $match[0], $reader->getPosition()));
