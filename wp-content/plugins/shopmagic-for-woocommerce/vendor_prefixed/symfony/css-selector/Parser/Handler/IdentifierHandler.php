 ...
 * @internal
 */
class IdentifierHandler implements \ShopMagicVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
{
    private $patterns;
    private $escaping;
    ...
    public function handle(\ShopMagicVendor\Symfony\Component\CssSelector\Parser\Reader $reader, \ShopMagicVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream)
    {
        ...
        $stream->push(new \ShopMagicVendor\Symfony\Component\CssSelector\Parser\Token(\ShopMagicVendor\Symfony\Component\CssSelector\Parser\Token::TYPE_IDENTIFIER, $value, $reader->getPosition()));
