 ...
 * @internal
 */
class ElementParser implements \ShopMagicVendor\Symfony\Component\CssSelector\Parser\ParserInterface
{
    /**
     * {@inheritdoc}
     */
    public function parse($source)
    {
        ...
        if (\preg_match('/^(?:([a-z]++)\\|)?([\\w-]++|\\*)$/i', \trim($source), $matches)) {
            return [new \ShopMagicVendor\Symfony\Component\CssSelector\Node\SelectorNode(new \ShopMagicVendor\Symfony\Component\CssSelector\Node\ElementNode($matches[1] ?: null, $matches[2]))];
        }
        return [];
    }
}
