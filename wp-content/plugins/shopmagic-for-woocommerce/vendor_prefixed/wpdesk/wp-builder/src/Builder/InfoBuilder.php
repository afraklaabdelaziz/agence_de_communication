 ...
 */
class InfoBuilder extends \ShopMagicVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\ShopMagicVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
