...
namespace ShopMagicVendor\WPDesk\PluginBuilder\Builder;
...
use ShopMagicVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \ShopMagicVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\ShopMagicVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \ShopMagicVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\ShopMagicVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
