...
if (!\interface_exists('ShopMagicVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('ShopMagicVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ShopMagicVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicVendor\WPDesk_Translatable, \ShopMagicVendor\WPDesk_Buildable, \ShopMagicVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
