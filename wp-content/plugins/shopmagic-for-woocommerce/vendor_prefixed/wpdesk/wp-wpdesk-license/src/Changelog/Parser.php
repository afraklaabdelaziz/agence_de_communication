...
namespace ShopMagicVendor\WPDesk\License\Changelog;

use ArrayObject;
use ShopMagicVendor\WPDesk\License\Changelog\Parser\Line;
/**
 * Can parse changelog.
 *
...
class Parser
{
    ...
    private function get_lines()
    {
        ...
        return \array_map(function ($line) {
            return new \ShopMagicVendor\WPDesk\License\Changelog\Parser\Line($line);
