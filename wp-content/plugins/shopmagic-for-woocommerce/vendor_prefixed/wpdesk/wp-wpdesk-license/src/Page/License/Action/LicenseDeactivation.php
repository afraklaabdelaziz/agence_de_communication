 ...
 */
class LicenseDeactivation extends \ShopMagicVendor\WPDesk\License\Page\License\Action\AbstractAction implements \ShopMagicVendor\WPDesk\License\Page\Action
{
    /**
    ...
    public function execute(array $plugin)
    {
        ...
        if ($activate_results['deactivated'] === \true) {
            ...
            $this->add_error('wc_am_deactivate_text', 'deactivate_msg', \__('Plugin license deactivated. ', 'shopmagic-for-woocommerce') . "{$activate_results['activations_remaining']}.", 'updated');
            $deactivated = \true;
