...
class WPDesk_Helper_List_Table extends \WP_List_Table
{
    ...
    {
        echo \wpautop(\__('No WP Desk plugins found.', 'shopmagic-for-woocommerce'));
    }
    ...
    {
        $columns = ['product_name' => \__('Plugin', 'shopmagic-for-woocommerce'), 'product_status' => \__('Subscription Status', 'shopmagic-for-woocommerce'), 'product_license' => \__('Subscription Data', 'shopmagic-for-woocommerce')];
        return $columns;
    }
    ...
    {
        $status = \__('Deactivated', 'shopmagic-for-woocommerce');
        if ($item['activation_status'] == 'Activated') {
            $status = \__('Activated', 'shopmagic-for-woocommerce');
        }
        return $status;
    }
