...
if (!\interface_exists('ShopMagicVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ShopMagicVendor\WPDesk_Requirement_Checker
    {
