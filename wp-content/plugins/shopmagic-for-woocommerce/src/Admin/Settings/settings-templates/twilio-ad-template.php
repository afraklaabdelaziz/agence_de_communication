...
<div class="shopmagic-cart-notice shopmagic-pro-notice">
	...
	<h1><?php esc_html_e( 'ShopMagic For Twilio', 'shopmagic-for-woocommerce' ); ?></h1>

	<h2><?php esc_html_e( '100% FREE SMS Sending Plugin for WooCommerce!', 'shopmagic-for-woocommerce' ); ?></h2>

	<p>
		<strong><?php esc_html_e( 'With ShopMagic now you can send sms to anyone.', 'shopmagic-for-woocommerce' ); ?></strong>
	</p>
