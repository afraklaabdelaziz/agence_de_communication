...
class ThemeHunk_Notify{
	...
	function enqueue(){
		wp_enqueue_style( 'owl.carousel', THEMEHUNK_MEGAMENU_URL.'notify/assets/css/owl.carousel.css', array(), '1.0.0' );
		wp_enqueue_style( 'hunk-companion-notice', THEMEHUNK_MEGAMENU_URL.'notify/assets/css/notice.css', array(), '1.0.0' );
		...
		wp_enqueue_script( 'hunk-companion-notify', THEMEHUNK_MEGAMENU_URL.'notify/assets/js/themehunk-notify.js', array( 'jquery' ), '',false );
	...
	function notify(){
		...
		$display = isset($_GET['notice-disable'])?'none':'block';
         ...
         require_once THEMEHUNK_MEGAMENU_DIR . 'notify/notify-html.php'; 
